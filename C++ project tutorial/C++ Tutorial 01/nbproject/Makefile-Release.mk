...
.NO_PARALLEL:${OBJECTDIR}/hello\ word.o
${OBJECTDIR}/hello\ word.o: hello\ word.cpp
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/hello\ word.o hello\ word.cpp
