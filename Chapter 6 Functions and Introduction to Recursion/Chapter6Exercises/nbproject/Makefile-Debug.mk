...
.build-conf: ${BUILD_SUBPROJECTS}
	"${MAKE}"  -f nbproject/Makefile-${CND_CONF}.mk ${CND_DISTDIR}/${CND_CONF}/${CND_PLATFORM}/chapter6exercises.exe
...
${OBJECTDIR}/ComputerAssisted_Instructions.o: ComputerAssisted_Instructions.cpp
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -g -std=c++14 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/ComputerAssisted_Instructions.o ComputerAssisted_Instructions.cpp

${OBJECTDIR}/Examples.o: Examples.cpp
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -g -std=c++14 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/Examples.o Examples.cpp

${OBJECTDIR}/GameOfChance.o: GameOfChance.cpp
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -g -std=c++14 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/GameOfChance.o GameOfChance.cpp

${OBJECTDIR}/RandomIntegers.o: RandomIntegers.cpp
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -g -std=c++14 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/RandomIntegers.o RandomIntegers.cpp
